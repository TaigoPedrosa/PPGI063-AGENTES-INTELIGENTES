...
4.  **Title**: Create a concise title: `<type>[scope]: <short description in English>`. For example: `feat(api): add new endpoint for user authentication`. The scope is optional but recommended for clarity. Check the complete [Conventional Commits Specification](https://www.conventionalcommits.org/en/v1.0.0/) for more details on formatting.
