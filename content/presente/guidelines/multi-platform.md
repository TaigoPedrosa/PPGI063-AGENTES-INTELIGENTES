...
| Prompts / slash commands | [Skills](https://code.claude.com/docs/en/skills) (commands have merged into skills); legacy `.claude/commands/*.md` | (no first-class equivalent) | — | [`.prompt.md`](https://code.visualstudio.com/docs/copilot/customization/prompt-files) in `.github/prompts/` | `/create-rule` etc. (built-ins) |
...
### ⚠️ Warnings before you ship a new custom agent to your repo
