...
> **Note on scope.** The Futuro folder has no billing/consumption data of its own (unlike the *present* team's "Tokens & IA 2026" cost page). So this page reframes "cost" as the **compute, training, and inference efficiency reported inside the papers** in `Futuro/pdfs/`, the economic story of world models. Every figure is quoted from its source paper; nothing is estimated by us.
>
...
| **V-JEPA 2** (per action) | 16 s | vs ~4 min for Cosmos (generative) | [Presentation 2, slide 10](pdfs/apresentacao-2-jepa-world-models.pdf) |
